						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
							<tbody>
								...
								<tr>
									...
									<td v-if="orderInfo.pay_status == 'paying' " align="left" bgcolor="#ffffff" id="pay_good">已支付&nbsp;&nbsp;&nbsp;&nbsp;
										<div style="text-align:center">
											<!--<a :href="orderInfo.alipay_url"><input type="button" @click="" id="pay_haha" value="立即使用支付宝支付"></a>-->
										</div>
									</td>
